    ...
    <div class="header-container">
        ...
        <div>
            ...
            <?php
                include "db.php";
                include "session.php";
                $sql = "SELECT mjesto.Naziv, mjesto.id_zup, mjesto.hylink FROM mjesto INNER JOIN bookmarks ON mjesto.id_mj=bookmarks.id_mjesta AND bookmarks.id_korisnika=$_SESSION[ID_k];";
                $counter=1;
